            ...
            <div className="lg:flex">
              <div className="w-full lg:w-1/2 mb-16 lg:mb-0 flex">
                <div className="w-full lg:w-1/2 px-6">
                  <ul>
                    <li>
                      <Link className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">
                        Components
                      </Link>
                    </li>
                    <li className="mt-6">
              ...
              <div className="w-full lg:w-1/2 flex">
                ...
                <div className="w-full lg:w-1/2 px-6 flex flex-col justify-between">
                  <div className="flex items-center mb-6">
                    ...
                    <a>
                      <div className="ml-3 text-gray-800 dark:text-gray-50 cursor-pointer hover:text-brand dark:hover:text-brand">
                        <FaFacebook />
                      </div>
                    </a>
                  </div>
